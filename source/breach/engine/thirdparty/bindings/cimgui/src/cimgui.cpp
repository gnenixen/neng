...
CIMGUI_API ImVec2 ImGuiViewport_GetWorkPos(ImGuiViewport* self)
{
    return self->GetWorkPos();
}
CIMGUI_API ImVec2 ImGuiViewport_GetWorkSize(ImGuiViewport* self)
{
...
CIMGUI_API void ImGuiViewport_GetWorkPos_nonUDT(ImVec2 *pOut,ImGuiViewport* self)
{
    *pOut = self->GetWorkPos();
}
CIMGUI_API ImVec2_Simple ImGuiViewport_GetWorkPos_nonUDT2(ImGuiViewport* self)
{
    ImVec2 ret = self->GetWorkPos();
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void ImGuiViewport_GetWorkSize_nonUDT(ImVec2 *pOut,ImGuiViewport* self)
{
    *pOut = self->GetWorkSize();
}
CIMGUI_API ImVec2_Simple ImGuiViewport_GetWorkSize_nonUDT2(ImGuiViewport* self)
{
    ImVec2 ret = self->GetWorkSize();
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
