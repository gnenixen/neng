...
*/
module engine.thirdparty.derelict.opengl.glloader;

import std.array;
import engine.thirdparty.derelict.util.system;
import engine.thirdparty.derelict.opengl.gl,
       engine.thirdparty.derelict.opengl.types : GLVersion, usingContexts;
...
struct GLLoader
{
    ...
    GLVersion loadExtra()
    {
        ...
        import engine.thirdparty.derelict.util.exception : DerelictException;
        ...
        _contextVersion = GLVersion.highestSupported;
    ...
    void bindGLFunc(void** ptr, string symName)
    {
        static if(Derelict_OS_Mac) {
            ...
            import engine.thirdparty.derelict.util.exception : SymbolLoadException;
