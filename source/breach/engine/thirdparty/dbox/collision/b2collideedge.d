 ...
 */
module engine.thirdparty.dbox.collision.b2collideedge;
...
struct b2EPAxis
{
    ...
    alias e_unknown = Type.e_unknown;
    alias e_edgeA = Type.e_edgeA;
    alias e_edgeB = Type.e_edgeB;
...
struct b2ReferenceFace
{
    ...
    b2Vec2 sideNormal1;
    float32 sideOffset1 = 0;

    b2Vec2 sideNormal2;
    float32 sideOffset2 = 0;
}
...
struct b2EPCollider
{
                 ...
                 const(b2PolygonShape) polygonB, b2Transform xfB)
    {
        ...
        else
        {
            ...
            ie[0].v = m_v1;
            ie[0].id.cf.indexA = 0;
            ie[0].id.cf.indexB = cast(uint8)(primaryAxis.index);
            ie[0].id.cf.typeA  = b2ContactFeature.Type.e_vertex;
            ie[0].id.cf.typeB  = b2ContactFeature.Type.e_face;

            ie[1].v = m_v2;
            ie[1].id.cf.indexA = 0;
            ie[1].id.cf.indexB = cast(uint8)(primaryAxis.index);
    ...
    b2EPAxis ComputePolygonSeparation()
    {
        ...
        b2Vec2 perp = b2Vec2(-m_normal.y, m_normal.x);
