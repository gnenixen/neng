 ...
 */
module engine.thirdparty.dbox.collision.b2collidecircle;
    ...
    const(b2CircleShape) circleB, b2Transform xfB)
{
    ...
    const(b2Vec2)* vertices = polygonA.m_vertices.ptr;
    const(b2Vec2)* normals  = polygonA.m_normals.ptr;
    ...
    else
    {
        ...
        float32 separation2 = b2Dot(cLocal - faceCenter, normals[vertIndex1]);
