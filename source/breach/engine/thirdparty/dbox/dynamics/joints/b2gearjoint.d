 ...
 */
module engine.thirdparty.dbox.dynamics.joints.b2gearjoint;
...
class b2GearJoint : b2Joint
{
    ...
    {
        super(def);
        m_joint1 = cast(b2Joint)def.joint1;
        m_joint2 = cast(b2Joint)def.joint2;
        ...
        float32 coordinateA = 0, coordinateB = 0;
...
public:
    ...
    override bool SolvePositionConstraints(b2SolverData data)
    {
        ...
        b2Vec2  JvAC, JvBD;
        float32 JwA = 0, JwB = 0, JwC = 0, JwD = 0;
        float32 mass = 0.0f;
    ...
    float32 m_referenceAngleA = 0;
    float32 m_referenceAngleB = 0;
    ...
    float32 m_mA = 0, m_mB = 0, m_mC = 0, m_mD = 0;
    float32 m_iA = 0, m_iB = 0, m_iC = 0, m_iD = 0;
