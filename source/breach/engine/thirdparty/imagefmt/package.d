...
module engine.thirdparty.imagefmt;

import core.stdc.stdio;
import cstd = core.stdc.stdlib;
import engine.thirdparty.imagefmt.bmp;
import engine.thirdparty.imagefmt.tga;
import engine.thirdparty.imagefmt.png;
import engine.thirdparty.imagefmt.jpeg;
...
version(IF__CUSTOM_ALLOC) {
    ...
    void* _malloc(size_t size)             { return if__malloc(size);       }
    void* _realloc(void* ptr, size_t size) { return if__realloc(ptr, size); }
    void _free(void* ptr)                  { return if__free(ptr);          }
} else {
